...
export const UsuarioCrear = () => {
  ...
  const enviarFormulario = async (fh: formaHtml) => {
    ...
    if (formulario.checkValidity() === false) {
      ...
      const resultado = await PrivateService.peticionPOST( ApiBack.USUARIOS_CREAR, objeto );
      ...
      if (resultado.id) {
        ...
        MessajeTostify( "error", "No se puede crear el usuario. Es posible que el correo exista en la BD", 7000 );
      }
    }
  };
