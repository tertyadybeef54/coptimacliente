...
import MiSesion from "../../models/MyLogin";
import CrearUsuario from "../../models/CreateUser";
import { propUsuario } from "../../models/MyInterfaces";
import logoReact from "../../../assets/image/icono.png";
import ServicioPublico from "../../services/PublicService";
...
export const Login = () => {
  ...
  const { actualizar } = useContext(UserContext) as propUsuario;
  ...
  const enviarFormulario = async (fh: formaHtml) => {
    ...
    if (formulario.checkValidity() === false) {
      ...
      if (resultado.tokenMintic) {
        ...
        MessajeTostify("Error", "Credenciales incorrectas", 7000);
      }
    }
  };
